...
% We don't "decide" stuff and show what happens. We propose as
% hypothesis that what we propose for solving the problem works. And
% then we prove it does - JJ
